...
public class BusinessUnit implements Serializable {
    ...
    public BusinessUnit(String displayName) throws EntityCreationException {
        this(displayName,displayName);
    }

    public BusinessUnit(String displayName, String referenceName) throws EntityCreationException {

...
public class TopicsServiceTest {
    ...
    @Test
    public void testCollaboratorsGettingTopics() throws EntityNotFoundException {
        when(mockRepo.findAllByDeletedIsFalse()).thenReturn(buildTopicList());

        List<TopicGroup> records = new ArrayList<>(topicsService.getAllTopics());
    ...
    @Test
    public void testCollaboratorsGettingAllTopics() throws EntityNotFoundException {
        when(mockRepo.findAllByCaseTypeAndDeletedIsFalse(CASETYPE)).thenReturn(buildTopicList());

        List<TopicGroup> records = new ArrayList<>(topicsService.getTopicByCaseType(CASETYPE));
    ...
    public void testAllListNotFoundThrowsListNotFoundException() throws EntityNotFoundException {
        ...
        List<TopicGroup> records = new ArrayList<>(topicsService.getTopicByCaseType(UNAVAILABLE_RESOURCE));
    ...
    @Test
    public void testServiceUpdateTopicsFromCSVAdd() throws EntityNotFoundException {
    ...
    @Test
    public void testServiceUpdateTopicsFromCSVRemove() throws EntityNotFoundException {
        Set<TopicGroup> topics = getTopicGroups();
        when(mockRepo.findAllByCaseType("Dept")).thenReturn(topics);
    ...
    @Test
    public void testServiceUpdateTopicsFromCSVRemoveChildTopic() throws EntityNotFoundException {
        Set<TopicGroup> topics = getTopicGroups();
        when(mockRepo.findAllByCaseType("Dept")).thenReturn(topics);
    ...
    @Test
    public void testServiceUpdateTopicsFromCSVBoth() throws EntityNotFoundException {
        Set<TopicGroup> topics = getTopicGroups();
        when(mockRepo.findAllByCaseType("Dept")).thenReturn(topics);
    ...
    @Test
    public void testServiceUpdateTopicsFromCSVSame() throws EntityNotFoundException {
        Set<TopicGroup> topics = getTopicGroups();
        when(mockRepo.findAllByCaseType("Dept")).thenReturn(topics);
    ...
    @Test
    public void testServiceUpdateTopicsFromCSVNothingNone() throws EntityNotFoundException {
        Set<TopicGroup> topics = getTopicGroups();
        when(mockRepo.findAllByCaseType("Dept")).thenReturn(topics);
